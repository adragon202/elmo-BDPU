...
proc create_root_design { parentCell } {
  ...
  # Create instance: one_pipe_test3_0, and set properties
  set one_pipe_test3_0 [ create_bd_cell -type ip -vlnv user.org:user:one_pipe_test3:1.0 one_pipe_test3_0 ]
...
CONFIG.CONST_WIDTH {32} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins one_pipe_test3_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net START_1 [get_bd_ports START] [get_bd_pins one_pipe_test3_0/START]
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins one_pipe_test3_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins one_pipe_test3_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins one_pipe_test3_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins one_pipe_test3_0/vector0] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconcat_1_dout [get_bd_pins one_pipe_test3_0/vector1] [get_bd_pins xlconcat_1/dout]
  ...
  connect_bd_net -net xlconstant_4_dout [get_bd_pins xlconcat_1/In0] [get_bd_pins xlconcat_1/In1] [get_bd_pins xlconcat_1/In2] [get_bd_pins xlconcat_1/In3] [get_bd_pins xlconstant_1/dout]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs one_pipe_test3_0/S00_AXI/S00_AXI_reg] SEG_one_pipe_test3_0_S00_AXI_reg
...
preplace port START -pg 1 -y 210 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 280 -defaultsOSRD
preplace port clk -pg 1 -y 590 -defaultsOSRD
preplace inst xlconstant_0 -pg 1 -lvl 1 -y 420 -defaultsOSRD
preplace inst xlconstant_1 -pg 1 -lvl 1 -y 500 -defaultsOSRD
preplace inst xlconcat_0 -pg 1 -lvl 2 -y 360 -defaultsOSRD
preplace inst xlconcat_1 -pg 1 -lvl 2 -y 500 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -y 120 -defaultsOSRD
preplace inst one_pipe_test3_0 -pg 1 -lvl 3 -y 390 -defaultsOSRD
...
preplace netloc START_1 1 0 3 NJ 210 430J 240 770J
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 420
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 2 440 270 760J
preplace netloc xlconcat_1_dout 1 2 1 770J
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 20 10 410
preplace netloc xlconstant_0_dout 1 1 1 460J
preplace netloc xlconcat_0_dout 1 2 1 750J
preplace netloc clk_1 1 0 3 NJ 590 NJ 590 780J
preplace netloc processing_system7_0_FIXED_IO 1 1 3 NJ 280 NJ 280 NJ
preplace netloc xlconstant_4_dout 1 1 1 460J
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 30 580 450 580 790J
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 780
preplace netloc rst_ps7_0_100M_interconnect_aresetn 1 1 1 440
levelinfo -pg 1 0 220 610 890 1010 -top 0 -bot 600
",
}
